...
app.get('/health', (req, res) => {
  ...
  const healthStatus = {
    ...
    discord: {
      ...
      ping: app.locals.discordClient ? app.locals.discordClient.ws.ping : 0
    },
    database: {
  ...
  // For Railway, accept health check even during Discord initialization
  // This prevents timeout during startup while Discord connects
  const isHealthy = healthStatus.database.url === 'configured' && uptime > 0;
